...
> **配套**:
> - [`apps/mobile/BUGS.md`](../apps/mobile/BUGS.md) — **完整 1176 行 / 75 BUG 详细案例** (项目状态/现象/根因/修法/教训/引用)
...
> - 最后更新: 2026-06-27 (S72 batch 10 收尾, v2.4, 新增 BUG-107 web + mobile KEY_LABEL 中英夹杂)
...
> **完整 1176 行 / 75 BUG 案例** 在 `apps/mobile/BUGS.md`, 按编号搜索定位.
