...
> - 最后更新: 2026-06-30 (S72 batch 30 v3.0.61 收口, v2.8, 新增 BUG-130 + 2 hotfix v3.0.60/61 + 跨项目通用铁律 3 条)
...
**最后更新**: 2026-06-30 (S72 batch 30 v2.8, 加 BUG-130 + 2 hotfix v3.0.60/61 + § 1 30 秒速览表新行 + § 2 4 个新关键字索引 + § 4 3 条新高频踩坑铁律 + § 5 79 BUG 完整列表 + § 7 4 个新 commit, 跨项目通用铁律新增: web+mobile 镜像必双端同步 + API 兼容性 > 不加重 + 文档说做了代码必须真做)
