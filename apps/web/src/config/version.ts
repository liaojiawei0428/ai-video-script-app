...
export const APP_VERSION_CODE = 100; // 跟 mobile android/app/build.gradle versionCode 同步 (v3.0.89 BUG-166 强制升级 modal 逃逸 + 公网下架老 APK), v3.0.96 BUG-172 实战盲点 3 修法: 加 console.log + 改 ForceUpdateModal 走 useState 替代 module-level state (修 v3.0.88 实战盲点 — module-level state + module-level 组件实例 + RN 0.73 Hermes 新架构兼容性问题)
