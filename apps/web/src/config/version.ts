...
export const APP_VERSION_CODE = 54; // 跟 mobile android/app/build.gradle versionCode 同步 (3.0.44=48, 3.0.45=49, 3.0.46=50, 3.0.47=51, 3.0.48=52, 3.0.49=53, 3.0.50=54)
