...
export const APP_VERSION_CODE = 84; // 跟 mobile android/app/build.gradle versionCode 同步 (v3.0.82 BUG-160 mobile 端 ProfileScreen 加通知 + AI 助手入口, 跟 web 端 NotificationBell + 1:1 镜像)
