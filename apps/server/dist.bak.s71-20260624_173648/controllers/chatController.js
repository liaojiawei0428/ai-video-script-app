...
const agnesTextProvider_1 = require("../services/agnesTextProvider");
...
exports.chatController = {
    ...
    async send(req, res, next) {
        ...
        try {
            ...
            logger_1.logger.info('Chat API called', {
            ...
            if (isStream) {
                ...
                for await (const chunk of agnesTextProvider_1.agnesTextProvider.streamChatCompletion(opts)) {
            ...
            const llmResult = await agnesTextProvider_1.agnesTextProvider.chatCompletion(opts);
            res.json({
                success: true,
                data: {
