...
exports.SUPPORTED_RATIOS = void 0;
exports.parseAspectToDims = parseAspectToDims;
exports.parseAspectRatioFromText = parseAspectRatioFromText;
exports.SUPPORTED_RATIOS = {
    '1:1': [1024, 1024],
    '2:3': [768, 1152],
    '3:2': [1152, 768],
    '3:4': [768, 1024],
 ...
 */
function parseAspectToDims(ratio) {
    if (!ratio)
        return null;
    const r = ratio.trim();
    if (!r || r === 'auto')
    ...
    const dims = exports.SUPPORTED_RATIOS[r];
    if (dims)
        return dims;
    // 3) 模糊匹配 (大小写不敏感, '4k' == '4K')
    for (const [key, val] of Object.entries(exports.SUPPORTED_RATIOS)) {
...
function parseAspectRatioFromText(text) {
    ...
    for (let i = messages.length - 1; i >= 0; i--) {
        ...
        for (const [key, [w, h]] of Object.entries(exports.SUPPORTED_RATIOS)) {
