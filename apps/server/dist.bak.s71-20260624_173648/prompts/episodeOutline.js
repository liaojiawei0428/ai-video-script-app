...
exports.episodeOutlineSystemPrompt = void 0;
exports.buildEpisodeOutlineUserPrompt = buildEpisodeOutlineUserPrompt;
/**
 * v2.5.13 - 分集大纲 prompt (风格感知版)
 * 输入: 全文 + 角色 + 风格圣经
 * 输出: JSON { items: [{ episodeNumber, title, summary, keyCharacters, estimatedDuration }] }
 */
const episodeOutlineSystemPrompt = (styleBibleBlock) => `你是一位资深影视编剧, 负责把小说拆分成短视频剧集。
...
`;
exports.episodeOutlineSystemPrompt = episodeOutlineSystemPrompt;
function buildEpisodeOutlineUserPrompt(params) {
