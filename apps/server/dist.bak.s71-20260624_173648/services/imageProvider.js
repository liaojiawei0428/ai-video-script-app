...
exports.imageProvider = exports.PlaceholderImageProvider = void 0;
exports.getDefaultImageProvider = getDefaultImageProvider;
exports.registerImageProvider = registerImageProvider;
exports.generateThreeVariants = generateThreeVariants;
...
exports.PlaceholderImageProvider = PlaceholderImageProvider;
// ════════════════════════════════════════════════════════════
//  Provider 注册表 + 工厂方法
// ════════════════════════════════════════════════════════════
let defaultProvider = new PlaceholderImageProvider();
function autoInitProvider() {
...
exports.imageProvider = autoInitProvider();
...
async function generateThreeVariants(prompt, styleId, baseSeed) {
    const provider = getDefaultImageProvider();
    const angles = ['front_bust', 'side_bust', 'full_body'];
    const styleSuffix = (0, stylePresets_1.getStylePromptSuffix)(styleId);
